                            ...
                            <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
                                ...
                                <div className="lg:col-span-1">
                                    <div className="flex items-center gap-2.5">
                                        <div className="flex size-9 items-center justify-center rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 shadow-lg shadow-green-500/25">
                                            <Leaf className="size-5 text-white" />
                                        </div>
                                        <AnimatedShinyText className="text-xl font-bold text-gray-900 dark:text-white">
                                            SocialImpact.id
                                        </AnimatedShinyText>
                                    </div>
                                    <p className="mt-4 text-sm leading-6 text-gray-500 dark:text-gray-400">
                                        Platform evaluasi program CSR terdepan
                                        di Indonesia. Ukur, kelola, dan
                                        tingkatkan dampak sosial perusahaan
                                        Anda.
                                    </p>
                                    {/* Social Links */}
